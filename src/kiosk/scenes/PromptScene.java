...
public class PromptScene implements Scene {
    ...
    public void init(Kiosk app) {
        ...
        int spacing = app.width / (this.answers.length + 1);  // Add 2 to account for the left and right
        int x = spacing;
    ...
    public void draw(Kiosk app) {
        ...
        for (int i = 0; i < this.answers.length; i++)
        {
            ...
            app.rect(answerButton.x + 100, answerButton.y + 25, answerButton.width, answerButton.height);
