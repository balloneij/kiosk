...
public class SpokeGraphSceneLoader {
     ...
     */
    public static void loadScene(SpokeGraphSceneModel model, AnchorPane editorPane, SceneGraph graph) {
    ...
    //TODO currently, Options and Colors are fields. Hopefully Options will be
    //TODO buttons, so then Colors is just included with it.

    //TODO temp; delete this boi
    private static Node getOptionsBox(SpokeGraphSceneModel model, SceneGraph graph) {
        var vbox = new VBox(new Label("TODO!!"));
        vbox.setPadding(PADDING);
        return vbox;
    }
